...
export default function LogScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      <Text style={styles.pageTitle}>Charging Log</Text>
      ...
      <View style={styles.summaryGrid}>
        ...
        <StatCard
          ...
          value={
            summary.totalKwh > 0
              ? `$${(summary.totalCost / summary.totalKwh).toFixed(3)}`
              : '—'
          }
        />
      </View>
      ...
      <View style={styles.tip}>
        ...
        <Text style={styles.tipText}>
          Tap a station on the Map tab to log directly from there, or use the button above.
        </Text>
      </View>
